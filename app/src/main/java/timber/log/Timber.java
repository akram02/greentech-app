...
public final class Timber {
    ...
    /**
     * A view into timber.log.Timber's planted trees as a tree itself. This can be used for injecting a logger
    ...
    public static void plant(@NotNull Tree tree) {
        ...
        if (tree == TREE_OF_SOULS) {
            throw new IllegalArgumentException("Cannot plant timber.log.Timber into itself.");
        }
        synchronized (FOREST) {
            FOREST.add(tree);
    ...
    /** A facade for handling logging calls. Install instances via {@link #plant timber.log.Timber.plant()}. */
